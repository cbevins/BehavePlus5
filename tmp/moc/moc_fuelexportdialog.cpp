/****************************************************************************
** FuelExportDialog meta object code from reading C++ file 'fuelexportdialog.h'
**
...
const char *FuelExportDialog::className() const
{
    return "FuelExportDialog";
}

QMetaObject *FuelExportDialog::metaObj = 0;
static QMetaObjectCleanUp cleanUp_FuelExportDialog( "FuelExportDialog", &FuelExportDialog::staticMetaObject );

#ifndef QT_NO_TRANSLATION
QString FuelExportDialog::tr( const char *s, const char *c )
{
    if ( qApp )
	return qApp->translate( "FuelExportDialog", s, c, QApplication::DefaultCodec );
    else
	return QString::fromLatin1( s );
}
#ifndef QT_NO_TRANSLATION_UTF8
QString FuelExportDialog::trUtf8( const char *s, const char *c )
{
    if ( qApp )
	return qApp->translate( "FuelExportDialog", s, c, QApplication::UnicodeUTF8 );
    else
...
QMetaObject* FuelExportDialog::staticMetaObject()
{
    if ( metaObj )
	return metaObj;
	...
	0, 0 );
    cleanUp_FuelExportDialog.setMetaObject( metaObj );
    return metaObj;
}

void* FuelExportDialog::qt_cast( const char* clname )
{
    if ( !qstrcmp( clname, "FuelExportDialog" ) )
	return this;
    return AppDialog::qt_cast( clname );
}

bool FuelExportDialog::qt_invoke( int _id, QUObject* _o )
{
...
bool FuelExportDialog::qt_emit( int _id, QUObject* _o )
{
    return AppDialog::qt_emit(_id,_o);
}
#ifndef QT_NO_PROPERTIES

bool FuelExportDialog::qt_property( int id, int f, QVariant* v)
{
    return AppDialog::qt_property( id, f, v);
}

bool FuelExportDialog::qt_static_property( QObject* , int , int , QVariant* ){ return FALSE; }
#endif // QT_NO_PROPERTIES
