/****************************************************************************
** FuelInitDialog meta object code from reading C++ file 'fuelinitdialog.h'
**
...
const char *FuelInitDialog::className() const
{
    return "FuelInitDialog";
}

QMetaObject *FuelInitDialog::metaObj = 0;
static QMetaObjectCleanUp cleanUp_FuelInitDialog( "FuelInitDialog", &FuelInitDialog::staticMetaObject );

#ifndef QT_NO_TRANSLATION
QString FuelInitDialog::tr( const char *s, const char *c )
{
    if ( qApp )
	return qApp->translate( "FuelInitDialog", s, c, QApplication::DefaultCodec );
    else
	return QString::fromLatin1( s );
}
#ifndef QT_NO_TRANSLATION_UTF8
QString FuelInitDialog::trUtf8( const char *s, const char *c )
{
    if ( qApp )
	return qApp->translate( "FuelInitDialog", s, c, QApplication::UnicodeUTF8 );
    else
...
QMetaObject* FuelInitDialog::staticMetaObject()
{
    if ( metaObj )
	return metaObj;
	...
	{ "rightButtonClicked(QListViewItem*,const QPoint&,int)", &slot_1, QMetaData::Protected },
	{ "itemDoubleClicked(QListViewItem*)", &slot_2, QMetaData::Protected },
	{ "store()", &slot_3, QMetaData::Protected }
    };
    metaObj = QMetaObject::new_metaobject(
	"FuelInitDialog", parentObject,
	slot_tbl, 4,
	0, 0,
	...
	0, 0 );
    cleanUp_FuelInitDialog.setMetaObject( metaObj );
    return metaObj;
}

void* FuelInitDialog::qt_cast( const char* clname )
{
    if ( !qstrcmp( clname, "FuelInitDialog" ) )
	return this;
...
bool FuelInitDialog::qt_emit( int _id, QUObject* _o )
{
    return AppDialog::qt_emit(_id,_o);
}
#ifndef QT_NO_PROPERTIES

bool FuelInitDialog::qt_property( int id, int f, QVariant* v)
{
    return AppDialog::qt_property( id, f, v);
}

bool FuelInitDialog::qt_static_property( QObject* , int , int , QVariant* ){ return FALSE; }
#endif // QT_NO_PROPERTIES
