...
void FuelModel::formatHtmlTable( const QString &title, QString &msg )
{
    ...
    msg += QString(
        ...
        .arg( m_load1 * 21.78, 0, 'g', 2 )
        .arg( m_load10 * 21.78, 0, 'g', 2 )
        .arg( m_load100 * 21.78, 0, 'g', 2 )
        .arg( m_loadHerb * 21.78, 0, 'g', 2 )
        .arg( m_loadWood * 21.78, 0, 'g', 2 );
...
bool FuelModel::loadBpf( const QString &fileName )
{
    ...
    {
        { "name=\"vSurfaceFuelBedDepth\"",     "ft",           1.0 },
        { "name=\"vSurfaceFuelBedMextDead\"",  "fraction",     .20 },
        { "name=\"vSurfaceFuelHeatDead\"",     "Btu/lb",    8000.0 },
        { "name=\"vSurfaceFuelHeatLive\"",     "Btu/lb",    8000.0 },
        { "name=\"vSurfaceFuelLoadDead1\"",    "lb/ft2",       0.0 },
        { "name=\"vSurfaceFuelLoadDead10\"",   "lb/ft2",       0.0 },
        { "name=\"vSurfaceFuelLoadDead100\"",  "lb/ft2",       0.0 },
        { "name=\"vSurfaceFuelLoadLiveHerb\"", "lb/ft2",       0.0 },
        { "name=\"vSurfaceFuelLoadLiveWood\"", "lb/ft2",       0.0 },
        { "name=\"vSurfaceFuelSavrDead1\"",    "ft2/ft3",   1500.0 },
        { "name=\"vSurfaceFuelSavrLiveHerb\"", "ft2/ft3",   1500.0 },
        { "name=\"vSurfaceFuelSavrLiveWood\"", "ft2/ft3",   1500.0 },
        { "name=\"vSurfaceFuelLoadTransferEq\"","ratio",         0 },
        { NULL,                                 NULL,          0.0 }
    };
...
bool FuelModelList::addStandardFuelModels( void )
{
    ...
    if ( ! ( addFuelModel ( "", 2, "2",
            ...
            "Timber grass and understory [2]",      // Pat's new name
            1.0, 0.15, 8000., 8000.,
    ...
    if ( ! ( addFuelModel ( "", 6, "6",
            "Dormant brush, hardwood slash [6]",
            2.5, 0.25, 8000., 8000.,
    ...
    if ( ! ( addFuelModel ( "", 8, "8",
            ...
            "Short needle litter [8]",      // Pat's new name
            0.2, 0.30, 8000., 8000.,
    ...
    if ( ! ( addFuelModel ( "", 9, "9",
            //"Hardwood litter [9]",
            "Long needle or hardwood litter [9]",   // Pat's new name
            0.2, 0.25, 8000., 8000.,
    ...
    if ( ! ( addFuelModel ( "", 10, "10",
            ...
            "Timber litter & understory [10]",  // Pat's new name
            1.0, 0.25, 8000., 8000.,
