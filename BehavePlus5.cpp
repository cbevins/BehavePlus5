...
static QString Version( "5.0.5" );
static QString Build( "Build 307" );
static QString ReleaseNote( "" );
static QString SplashFile( "BehavePlus5.bmp" );		// SEE LINE 274 !!!
//static QString SplashFile( "splash306.bmp" );
