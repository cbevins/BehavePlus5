...
void BpDocument::maintenanceMenuActivated( int id )
{
    ...
    if ( id == 101 )
    {
        m_eqTree->printDotFile( "BehavePlus5.dot", m_eqTree->m_release );
        return;
    }
    if ( id == 102 )
    {
        m_eqTree->printDotFile( "BehavePlus5.dot", 99999 );
        return;
    }
